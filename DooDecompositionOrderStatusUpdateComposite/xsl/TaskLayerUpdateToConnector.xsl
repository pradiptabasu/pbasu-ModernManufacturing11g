...
<xsl:stylesheet version="1.0" xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/" xmlns:xp20="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.Xpath20" xmlns:ns4="http://xmlns.oracle.com/apps/scm/doo/decomposition/DooDecompositionOrderStatusUpdateComposite" xmlns:bpel="http://docs.oasis-open.org/wsbpel/2.0/process/executable" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bpm="http://xmlns.oracle.com/bpmn20/extensions" xmlns:plnk="http://schemas.xmlsoap.org/ws/2003/05/partner-link/" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tns="http://xmlns.oracle.com/apps/scm/doo/common/events/service/" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:ora="http://schemas.oracle.com/xpath/extension" xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator" xmlns:errors="http://xmlns.oracle.com/adf/svc/errors/" xmlns:types="http://xmlns.oracle.com/apps/scm/doo/common/events/service/types/" xmlns:mhdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.mediator.service.common.functions.MediatorExtnFunction" xmlns:oraext="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.ExtFunc" xmlns:ns1="commonj.sdo/xml" xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue" xmlns:ns2="http://xmlns.oracle.com/adf/svc/types/" xmlns:hwf="http://xmlns.oracle.com/bpel/workflow/xpath" xmlns:ns3="commonj.sdo/java" xmlns:med="http://schemas.oracle.com/mediator/xpath" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ids="http://xmlns.oracle.com/bpel/services/IdentityService/xpath" xmlns:xdk="http://schemas.oracle.com/bpel/extension/xpath/function/xdk" xmlns:xref="http://www.oracle.com/XSL/Transform/java/oracle.tip.xref.xpath.XRefXPathFunctions" xmlns:ns0="commonj.sdo" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:client="http://xmlns.oracle.com/apps/scm/doo/taskLayer/externalInterfaceLayer/DooTaskExternalInterfaceVirtualPartnersComposite/BusinessEventsConnector" xmlns:bpmn="http://schemas.oracle.com/bpm/xpath" xmlns:tm="http://xmlns.oracle.com/topologyManager/client/xpath/extension" xmlns:orafault="http://xmlns.oracle.com/oracleas/schema/oracle-fault-11_0" xmlns:ldap="http://schemas.oracle.com/xpath/extension/ldap" exclude-result-prefixes="xsi xsl plnk soap tns wsdl errors types ns1 ns2 ns3 ns0 xsd orafault ns4 client bpws xp20 bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref bpmn tm ldap">
   <xsl:template match="/">
      <ns4:results>
         <xsl:for-each select="/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result">
            <ns4:OrderHeader>
               <ns4:EventCode>
                  ...
                  <ns4:OrderLine>
                     ...
                     <xsl:for-each select="tns:OrderUpdateFulfillLineTR">
                        <ns4:OrderFulfillmentLine>
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ActualShipDateNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ActualShipDateOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:BillToContactIdNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:BillToContactIdOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:BillToCustomerIdNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:BillToCustomerIdOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:FobPointCodeNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:FobPointCodeOld) > 0.0)">
                              <ns4:FobPointCodeNew>
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:FulfillOrgIdNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:FulfillOrgIdOld) > 0.0)">
                              <ns4:FulfillOrgIdNew>
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:InventoryItemIdNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:InventoryItemIdOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderedQtyNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderedQtyOld) > 0.0)">
                              <ns4:OrderedQtyNew>
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:PromiseArrivalDateNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:PromiseArrivalDateOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:PromiseShipDateNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:PromiseShipDateOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:RequestArrivalDateNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:RequestArrivalDateOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ScheduleShipDateNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ScheduleShipDateOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ScheduleArrivalDateNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ScheduleArrivalDateOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ShipClassOfServiceNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ShipClassOfServiceOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ShipModeOfTransportNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ShipModeOfTransportOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ShipToContactIdNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ShipToContactIdOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ShipToCustomerIdNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ShipToCustomerIdOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ShipToSiteUseIdNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ShipToSiteUseIdOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:TaxClassificationCodeNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:TaxClassificationCodeOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:TaxExemptFlagNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:TaxExemptFlagOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:UnitSellingPriceNew) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:UnitSellingPriceOld) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ActualCompletionDateOld) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ActualCompletionDateNew) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:BillToSiteUseIdOld) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:BillToSiteUseIdNew) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:CarrierIdOld) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:CarrierIdNew) > 0.0)">
                              <ns4:CarrierIdNew>
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:DemandClassCodeOld) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:DemandClassCodeNew) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:FulfillmentDateOld) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:FulfillmentDateNew) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:LatestAcceptableShipDateOld) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:LatestAcceptableShipDateNew) > 0.0)">
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:RemnantFlagOld) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:RemnantFlagNew) > 0.0)">
                              <ns4:RemnantFlagNew>
                           ...
                           <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ReturnReasonCodeOld) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:ReturnReasonCodeNew) > 0.0)">
                           ...
                           <xsl:for-each select="tns:OrderUpdateFulfillLineDetailTR">
                              <ns4:OrderFulfillmentLineDetails>
                                 ...
                                 <xsl:if test="string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:BillingTransactionNumber) > 0.0">
                                 ...
                                 <xsl:if test="string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:BillingTransactionDate) > 0.0">
                                 ...
                                 <xsl:if test="string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:BillingTransactionAmount) > 0.0">
                                 ...
                                 <xsl:if test="string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:WaybillNumber) > 0.0">
                                    <ns4:WaybillNumber>
                                 ...
                                 <xsl:if test="string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:BillOfLaddingNumber) > 0.0">
                                 ...
                                 <xsl:if test="string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:TrackingNumber) > 0.0">
                                    <ns4:TrackingNumber>
                                 ...
                                 <xsl:if test="string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:Quantity) > 0.0">
                                    <ns4:Quantity>
                                 ...
                                 <xsl:if test="string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:Status) > 0.0">
                                    <ns4:Status>
                                 ...
                                 <xsl:if test="string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:DeliveryName) > 0.0">
                                    <ns4:DeliveryName>
                                 ...
                                 <xsl:if test="string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:RmaReceiptNumber) > 0.0">
                                 ...
                                 <xsl:if test="string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:RmaReceiptLineNumber) > 0.0">
                                 ...
                                 <xsl:if test="string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:RmaReceiptDate) > 0.0">
                                    <ns4:RmaReceiptDate>
                                 ...
                                 <xsl:if test="string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:RmaReceiptTransactionId) > 0.0">
                                 ...
                                 <xsl:if test="string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:CustomerTrxLineId) > 0.0">
                                 ...
                                 <xsl:for-each select="tns:OrderUpdateFlexTR">
                                    <ns4:OrderFulfillmentLineEFFs>
                                       ...
                                       <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:OrderUpdateFlexTR/tns:SegmentDateOldValue) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:OrderUpdateFlexTR/tns:SegmentDateNewValue) > 0.0)">
                                       ...
                                       <xsl:if test="(string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:OrderUpdateFlexTR/tns:SegmentTimeOldValue) > 0.0) or (string-length(/types:preparePayloadForTaskLayerOrderUpdateEventResponse/types:result/tns:OrderUpdateLineTR/tns:OrderUpdateFulfillLineTR/tns:OrderUpdateFulfillLineDetailTR/tns:OrderUpdateFlexTR/tns:SegmentTimeNewValue) > 0.0)">
