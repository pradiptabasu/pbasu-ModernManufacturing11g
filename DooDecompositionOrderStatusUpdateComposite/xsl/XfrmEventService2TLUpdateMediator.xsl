...
<xsl:stylesheet version="1.0" xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/" xmlns:xp20="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.Xpath20" xmlns:inp="http://xmlns.oracle.com/apps/scm/doo/decomposition/DooDecompositionOrderStatusUpdateComposite" xmlns:bpel="http://docs.oasis-open.org/wsbpel/2.0/process/executable" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ns4="http://xmlns.oracle.com/apps/scm/doo/decomposition/DooDecompositionOrderStatusUpdateComposite/BusinessEventNotificationMediator" xmlns:bpm="http://xmlns.oracle.com/bpmn20/extensions" xmlns:plnk="http://schemas.xmlsoap.org/ws/2003/05/partner-link/" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tns="http://xmlns.oracle.com/apps/scm/doo/common/events/service/" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:ora="http://schemas.oracle.com/xpath/extension" xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator" xmlns:errors="http://xmlns.oracle.com/adf/svc/errors/" xmlns:types="http://xmlns.oracle.com/apps/scm/doo/common/events/service/types/" xmlns:inp2="/oracle/apps/scm/doo/processOrder/model/entity/events/schema/FulfillLineEO" xmlns:mhdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.mediator.service.common.functions.MediatorExtnFunction" xmlns:oraext="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.ExtFunc" xmlns:ns1="commonj.sdo/xml" xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue" xmlns:ns2="http://xmlns.oracle.com/adf/svc/types/" xmlns:hwf="http://xmlns.oracle.com/bpel/workflow/xpath" xmlns:ns3="commonj.sdo/java" xmlns:med="http://schemas.oracle.com/mediator/xpath" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ids="http://xmlns.oracle.com/bpel/services/IdentityService/xpath" xmlns:xdk="http://schemas.oracle.com/bpel/extension/xpath/function/xdk" xmlns:xref="http://www.oracle.com/XSL/Transform/java/oracle.tip.xref.xpath.XRefXPathFunctions" xmlns:ns0="commonj.sdo" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:bpmn="http://schemas.oracle.com/bpm/xpath" xmlns:tm="http://xmlns.oracle.com/topologyManager/client/xpath/extension" xmlns:orafault="http://xmlns.oracle.com/oracleas/schema/oracle-fault-11_0" xmlns:ldap="http://schemas.oracle.com/xpath/extension/ldap" exclude-result-prefixes="xsi xsl plnk soap tns wsdl errors types ns1 ns2 ns3 ns0 xsd orafault inp ns4 inp2 bpws xp20 bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref bpmn tm ldap">
   <xsl:template match="/">
      <inp:MediatorInput>
                        ...
                        <tns:OrderUpdateFulfillLineTR>
                           ...
                           <xsl:for-each select="tns:OrderUpdateFulfillLineDetailTR">
                              <tns:OrderUpdateFulfillLineDetailTR>
                                 ...
                                 <xsl:if test="string-length(tns:BillingTransactionNumber) > 0.0">
                                 ...
                                 <xsl:if test="string-length(tns:BillingTransactionDate) > 0.0">
                                 ...
                                 <xsl:if test="string-length(tns:BillingTransactionAmount) > 0.0">
                                 ...
                                 <xsl:if test="string-length(tns:WaybillNumber) > 0.0">
                                    <tns:WaybillNumber>
                                 ...
                                 <xsl:if test="string-length(tns:BillOfLaddingNumber) > 0.0">
                                 ...
                                 <xsl:if test="string-length(tns:TrackingNumber) > 0.0">
                                    <tns:TrackingNumber>
                                 ...
                                 <xsl:if test="string-length(tns:Quantity) > 0.0">
                                    <tns:Quantity>
                                 ...
                                 <xsl:if test="string-length(tns:Status) > 0.0">
                                    <tns:Status>
                                 ...
                                 <xsl:if test="string-length(tns:DeliveryName) > 0.0">
                                    <tns:DeliveryName>
                                 ...
                                 <xsl:if test="string-length(tns:RmaReceiptNumber) > 0.0">
                                 ...
                                 <xsl:if test="string-length(tns:RmaReceiptLineNumber) > 0.0">
                                 ...
                                 <xsl:if test="string-length(tns:RmaReceiptDate) > 0.0">
                                    <tns:RmaReceiptDate>
                                 ...
                                 <xsl:if test="string-length(tns:RmaReceiptTransactionId) > 0.0">
                                 ...
                                 <xsl:if test="string-length(tns:CustomerTrxLineId) > 0.0">
                                 ...
                                 <xsl:for-each select="tns:OrderUpdateFlexTR">
                                    <tns:OrderUpdateFlexTR>
                                       ...
                                       <xsl:if test="(string-length(tns:SegmentCharOldValue) > 0.0) or (string-length(tns:SegmentCharNewValue) > 0.0)">
                                       ...
                                       <xsl:if test="(string-length(tns:SegmentNumOldValue) > 0.0) or (string-length(tns:SegmentNumNewValue) > 0.0)">
                                       ...
                                       <xsl:if test="(string-length(tns:SegmentDateOldValue) > 0.0) or (string-length(tns:SegmentDateNewValue) > 0.0)">
                                          <tns:SegmentDateOldValue>
                                       ...
                                       <xsl:if test="(string-length(tns:SegmentTimeOldValue) > 0.0) or (string-length(tns:SegmentTimeNewValue) > 0.0)">
                                          <tns:SegmentTimeOldValue>
